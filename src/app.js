...
const routes = [
  ...
  ['ngo-verification', safeRequire('./modules/ngos/ngo.verification.routes')],
  ['assignments',      safeRequire('./modules/assignments/ngo.assignment.routes')],
  ['ai-verification',  safeRequire('./modules/ai/ai.verification.routes')],
  ['fees',             safeRequire('./modules/fees/fee.routes')],
  ['fees',             safeRequire('./modules/fees/fee.routes')],
